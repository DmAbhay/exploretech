...
@Component
public class GenerateIdForParticipant implements IdentifierGenerator {

    private static final String PREFIX = "EXPLORETECH";
    private static final String SUFFIX = "PARTICIPANT";

    @Override
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        try {
            String query = "SELECT TOP 1 id FROM Participant WHERE id LIKE 'EXPLORETECH%' ORDER BY id DESC";
