...
@Component
public class GenerateIdForApplicant implements IdentifierGenerator {

    private static final String PREFIX = "EXPLORETECH";
    private static final String SUFFIX = "APPLICANT";

    @Override
    public Serializable generate(SharedSessionContractImplementor session, Object object) {
        try {
            String query = "SELECT TOP 1 id FROM applicant WHERE id LIKE 'EXPLORETECH%' ORDER BY id DESC";
